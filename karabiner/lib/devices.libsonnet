...
];
{
  ...
  keychron:
      self.device( true, false, 53296, 13364, false, [] ),
  naga_mouse:
      self.device( false, true, 180, 5426, false, naga_map),
  naga:
      self.device(true,false,180,5426,false, naga_map),
  naga_blue:
      self.device( true, true, 181, 1678, false, naga_map),
}
